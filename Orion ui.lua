...
local OrionLib = {
	...
	Themes = {
		Default = {
			Main = Color3.fromRGB(10, 10, 40),       -- 背景メイン（濃い夜空の青）
			Second = Color3.fromRGB(25, 25, 70),     -- サブパネル（青紫）
			Stroke = Color3.fromRGB(80, 80, 120),    -- 枠線
			Divider = Color3.fromRGB(50, 50, 90),    -- 区切り線
			Text = Color3.fromRGB(220, 220, 255),    -- メイン文字（白っぽく）
			TextDark = Color3.fromRGB(150, 150, 200) -- 補助文字（薄紫）
		}
	},
